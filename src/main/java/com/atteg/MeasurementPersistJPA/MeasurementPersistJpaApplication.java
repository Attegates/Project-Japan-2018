...
public class MeasurementPersistJpaApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        String ss = "Da,07/03/2018,TI,09:31,AG,22,Hm,180.0,Wk,112.3,FW,34.1,fW,38.3,mW,70.4,bW,3.6,MI,34.7,IF,13,rA,37,BMR,2292,MW,74.0,wW,51.7,ww,46.0,wI,29.9,wO,21.8,wo,42.2,FR,34.8,fR,7.0,mR,12.5,FL,34.3,fL,6.9,mL,12.6,Fr,29.0,fr,2.0,mr,4.5,Fl,32.3,fl,2.2,ml,4.3,FT,34.6,fT,20.2,mT,36.5";
        Measurement measurement = this.measurementBuilder.buildMeasurement(s);
        Measurement mmm = this.measurementBuilder.buildMeasurement(ss);
